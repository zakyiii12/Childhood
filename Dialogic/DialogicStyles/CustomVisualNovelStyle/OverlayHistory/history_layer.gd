...
func add_history():
	...
	for info: Dictionary in history_subsystem.call(&'get_simple_history'):
		...
		history_item.get_child(0).get_child(3).text = "History-" + str(i) 
