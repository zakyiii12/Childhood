...
@onready var saved_name: Label = $HBoxContainer/SavedName
...
func _on_backtrack_btn_pressed() -> void:
	Dialogic.Save.load(saved_name.text)
	GameManager.close_history = true
